...
# Always enabled security settings (both development and production)
...
CSP_STYLE_SRC = ("'self'", "'unsafe-inline'")  # Allow inline styles for crispy-forms
CSP_SCRIPT_SRC = ("'self'",)
CSP_IMG_SRC = ("'self'",)
CSP_FONT_SRC = ("'self'",)
...
STATIC_URL = '/static/'
STATIC_ROOT = '/home/ubuntu/webapps2025/static'
STATICFILES_DIRS = []
